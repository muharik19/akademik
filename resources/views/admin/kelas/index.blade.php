        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="pull-right">
                    <button type="button" class="btn btn-primary add-new"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Kelas</button>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="list-kelas" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Jurusan</th>
...
<script>
    $(document).ready(function() {
        $('.add-new').on('click', function() {
            window.location = `${SITEURL}/kelas/kelas-add-new`;
        });
