                        ...
                        <form class="" action="{{ route('majors.store') }}" method="POST" autocomplete="off">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control @error('kode_jurusan') is-invalid @enderror" type="text" name="kode_jurusan" id="kode_jurusan" placeholder="Kode Jurusan" value="{{ old('kode_jurusan') }}" required="required" />
                                    @error('kode_jurusan')
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control @error('nama_jurusan') is-invalid @enderror" type="text" name="nama_jurusan" id="nama_jurusan" placeholder="Nama Jurusan" value="{{ old('nama_jurusan') }}" required="required" />
                                    @error('nama_jurusan')
                                        <span class="badge badge-warning">{{ $message }}</span>
                                    @enderror
                                </div>
