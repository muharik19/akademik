@extends('layouts.app')
@section('title', 'Management Jurusan')
@section('css')
        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="pull-right">
                    <button type="button" class="btn btn-primary add-new"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Jurusan</button>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $('.add-new').on('click', function() {
            window.location = `${SITEURL}/major/major-add-new`;
        });
